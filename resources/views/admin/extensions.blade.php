    ...
    <div class="blueprint-page-header">
      <div class="row">
        <div class="col-lg-8 col-md-9 col-sm-9 col-xs-12" style="padding-top: 3px; padding-bottom: 3px;">
          ...
          <span>
            Xcure's favorite modding community. Develop, collaborate and install extensions with the extension platform that puts you first. Xcure themes, plugin installers, player managers, admin tools and much more. There's a Blueprint extension for that.
          </span>
        </div>
