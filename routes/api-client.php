...
Route::prefix('/account')->middleware(AccountSubject::class)->group(function () {
    ...
    // Panel protect routes removed, now per-server in /servers/{server} group
...
Route::group([
    ...
    Route::group(['prefix' => '/protect'], function () {
        Route::get('/', [Client\PanelProtectController::class, 'index'])->name('api:client.server.protect');
        Route::post('/toggle', [Client\PanelProtectController::class, 'toggle'])->name('api:client.server.protect.toggle');
    });
});
