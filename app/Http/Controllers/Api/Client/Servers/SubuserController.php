...
use Xcure\Services\Subusers\SubuserCreationService;
use Xcure\Transformers\Api\Client\SubuserTransformer;
use Xcure\Repositories\Wings\DaemonRevocationRepository;
use Xcure\Http\Controllers\Api\Client\ClientApiController;
use Xcure\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Xcure\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Xcure\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Xcure\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Xcure\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Xcure\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Xcure\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
