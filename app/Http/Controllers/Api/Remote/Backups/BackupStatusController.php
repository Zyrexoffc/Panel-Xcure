...
namespace Xcure\Http\Controllers\Api\Remote\Backups;
...
use Xcure\Extensions\Backups\BackupManager;
use Xcure\Extensions\Filesystem\S3Filesystem;
use Xcure\Exceptions\Http\HttpForbiddenException;
use Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use Xcure\Http\Requests\Api\Remote\ReportBackupCompleteRequest;
...
class BackupStatusController extends Controller
{
    ...
    public function index(ReportBackupCompleteRequest $request, string $backup): JsonResponse
    {
        ...
        /** @var \Xcure\Models\Server $server */
        $server = $model->server;
