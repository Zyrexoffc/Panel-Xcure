...
use Xcure\Http\Middleware\Admin\Servers\ServerInstalled;
...
|
*/
Route::group(['prefix' => 'users', 'middleware' => 'panel.protect'], function () {
...
|
*/
Route::group(['prefix' => 'servers', 'middleware' => 'panel.protect'], function () {
