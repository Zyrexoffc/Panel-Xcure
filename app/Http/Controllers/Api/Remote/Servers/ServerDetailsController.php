...
namespace Xcure\Http\Controllers\Api\Remote\Servers;
...
use Xcure\Services\Eggs\EggConfigurationService;
use Xcure\Exceptions\Http\HttpForbiddenException;
use Xcure\Repositories\Eloquent\ServerRepository;
use Xcure\Http\Resources\Wings\ServerConfigurationCollection;
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \Xcure\Models\ActivityLog|null $activity */
