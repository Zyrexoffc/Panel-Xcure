 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Xcure\Models\Task> $tasks
 */
class Schedule extends Model
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Xcure\Models\Task, $this>
     */
